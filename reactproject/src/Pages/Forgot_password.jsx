...
function Forgot_password() {
  return (
    <div className="Box2">
    <div className="ForgotOpacity">
        <div className="ForgotScreen">
            <div className="forgotIn">
                <p className="forgot_text">Я не помню пароль</p>
                <p className="forg_text">Введи свой email и мы вышлем тебе инструкции по изменению пароля</p>
            <div className="cr_input Email em1">
              ...
              />
                ...
                <button className="btnCreate">Запросить новый пароль</button>
            </div>
        </div>
    </div>
